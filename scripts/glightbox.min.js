;(function (global, factory) {
	...
	var defaults = {
		...
		svg: {
			close: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 34 34" fill="none" stroke="white"><path d="M12.7574 12.7575L17 17.0002M17 17.0002L21.2426 21.2428M17 17.0002L21.2426 12.7575M17 17.0002L12.7574 21.2428" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
			next: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="white"><path d="M9 6L15 12L9 18" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
			prev: '<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="white"><path d="M15 6L9 12L15 18" stroke-width="1.5" stroke-linecap="round" stroke-linejoin="round"/></svg>',
		},
	}
	defaults.slideHTML =
